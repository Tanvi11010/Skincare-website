...
<body>
    ...
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td><img src="images/pro1.jpg" alt="Product" width="60" height="60"> Plum Face Wash</td>
                    <td>₹800</td>
                    <td>
                ...
                <tr>
                    <td><img src="images/pro6.jpg" alt="Product" width="60" height="60"> Aqualogica Moisturizer</td>
                    <td>₹300</td>
                    <td>
                        <button class="btn btn-success">Add to Cart</button>
                        <button class="btn btn-danger">Remove</button>
                ...
                <!-- Repeat similar structure for other wishlist items -->
            </tbody>
        </table>
    </div>
    <br><br><br>
